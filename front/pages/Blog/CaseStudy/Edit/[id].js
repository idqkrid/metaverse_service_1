...
const CaseStudy = () => {
  ...
  const { singlePost, updatePostDone, imagePaths, addPostLoading, addPostDone } = useSelector((state) => state.post);
  ...
  const onRemoveImageNew = useCallback((index) => () => {
    console.log(index)
                    ...
                    <div className={styles.imageSpace}>
                      {imagePaths.map((v, i) => (
                        <div key={v} style={{ display: 'inline-block' }}>
                          ...
                          <div>
                            <button className={styles.buttonWrap} onClick={onRemoveImageNew(i)}>제거</button>
                          </div>
                        </div>
                      ))}
                    </div>
                    <div className={styles.imageSpace}>
                      {singlePost?.Images.map((v, i) => (
                        <div key={v} style={{ display: 'inline-block' }}>
                          ...
                          <div>
                            <button className={styles.buttonWrap} onClick={onRemoveImage(v.id)}>제거</button>
                          </div>
                        </div>
                      ))}
                    </div>
