...
const SpaceScrean = () => {
  ...
  const { mainPosts, hasMorePosts, loadPostsLoading, addMetaDone, metaRooms } =
      ...
      <div>
        <div className={styles.title}>
          <ul className={styles.titleNav}>
            <li onClick={() => setShowFirst(true)}>
              <div className={styles.allButton}>🌝 전체</div>
            </li>
            <li onClick={() => setShowFirst(false)}>
              <div className={styles.allButton}>🍊 내 스페이스</div>
            </li>
          </ul>
          <ul className={styles.navTwo}>
            <li>
              <div className={styles.more2}>
                <div className={styles.more2Floor1} onClick={openModal}>
                  + 스페이스 만들기
                </div>
              </div>
            </li>
          ...
          <>
            <div className={styles.cotent1}>
              <div className={styles.gridContainer}>
                {metaRooms?.map((post) => (
                  <SpaceCardForm key={post.id} post={post} />
                ))}
              </div>
            </div>
          </>
          ...
          <div className={styles.modalOverlay}>
            <div className={styles.modal}>
              <div className={styles.modalTitle}>
                ...
                <div className={styles.modalTitleContent2} onClick={closeModal}>
                  x
                </div>
              </div>
